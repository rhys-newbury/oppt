...
namespace oppt
{
class CarMazeRRTHeuristicPlugin: public HeuristicPlugin
{
public:
    CarMazeRRTHeuristicPlugin():
        HeuristicPlugin() {

    }

    virtual ~CarMazeRRTHeuristicPlugin() {
...
OPPT_REGISTER_HEURISTIC_PLUGIN(CarMazeRRTHeuristicPlugin)
