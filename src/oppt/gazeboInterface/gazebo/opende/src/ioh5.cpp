...
// lookup.  This type of clumsy initialization is a necessary evil.
  static    const h5_type h5_type_list[] = {
    ...
    {typeid(float)                 , PredType::NATIVE_FLOAT,   double ( PredType::NATIVE_FLOAT   ),   "float"                  },
    {typeid(double)                , PredType::NATIVE_DOUBLE,  double ( PredType::NATIVE_DOUBLE  ),   "double"                 },
    {typeid(long double)           , PredType::NATIVE_LDOUBLE, double ( PredType::NATIVE_LDOUBLE ),   "long double"            },
