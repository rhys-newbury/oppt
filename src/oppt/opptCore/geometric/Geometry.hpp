...
public:
    ...
    /**
     * @brief Get the parent oppt::Body of this geometry
     * @return A pointer to the parent body of this geometry. If it has no parent body, a nullptr is returned
     */
    oppt::Body* getParentBody() const;
