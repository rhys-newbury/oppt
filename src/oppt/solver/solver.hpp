...
#include "oppt/problemEnvironment/SimulationResult.hpp"
...
public:
     ...
     */
    virtual void runFinished(std::ofstream& os, const unsigned int &run, const SimulationResult &simulationResult) {}
