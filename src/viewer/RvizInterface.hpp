...
public:
    ...
    void lookAt(const double &x, const double &y, const double &z) const;
...
private:
    ...
    void receiveBackgroundColorCommand(const geometry_msgs::Vector3ConstPtr &msg);

    void receiveLookAtCommand(const geometry_msgs::PointConstPtr &msg);
...
private:
    ...
    std::unique_ptr<ros::Subscriber> sub7_ = nullptr;
    std::unique_ptr<ros::Subscriber> sub8_ = nullptr;
